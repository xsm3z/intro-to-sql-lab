...
-- Write SQL query here
SELECT language FROM countrylanguages JOIN countries ON countries.code = countrylanguages.countrycode WHERE countries.code = 'VAT';
-- ITALIAN
-- Clue #3: We have new news on the classes Carmen attended – our gumshoes tell us she's moved on to a different country, a country where people speak only the language she was learning. Find out which nearby country speaks nothing but that language.

-- Write SQL query here
SELECT * FROM countries JOIN countrylanguages ON countries.code = countrylanguages.countrycode WHERE language= 'Italian' AND isofficial= True;
-- SAN MARINO
...
-- Write SQL query here
SELECT * from cities JOIN countries on countries.code = cities.countrycode WHERE countries.continent = 'South America' AND cities.name LIKE 'S%' ORDER BY cities.name ASC;
--SERRA
...
-- Write SQL query here
SELECT cities.name FROM cities JOIN countries on cities.id = countries.capital WHERE countries.name = 'Brazil';
--BRASILIA
